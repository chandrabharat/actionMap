...
Rails.application.routes.draw do
    ...
    resources :representatives do
        ...
        ###MY Own###
        get '/representatives/:representative_id/my_news_item/find' => 'my_news_items#search_news',
            :as                                                    => :find
    ...
    # My Own Routes
    get '/show', to: 'representatives#show', as: 'show'
    
    delete '/representatives/:representative_id/my_news_item/:id/delete', to:  'my_news_items#destroy',
    as: 'delete_news_item'

    get '/index', to: 'news_items#index', as: 'index'

    get '/representatives/:representative_id/my_news_item/search' => 'news_api#search',
        :as                                                    => :find_my_news_item
